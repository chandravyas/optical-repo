...
public class ProductOrderResourceIntTest {
     ...
     *
     * @see com.opticalshopall.app.repository.search.ProductOrderSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createProductOrder() throws Exception {
        ...
        assertThat(testProductOrder.getTotalCost()).isEqualTo(DEFAULT_TOTAL_COST);
    ...
    public void updateProductOrder() throws Exception {
        ...
        assertThat(testProductOrder.getTotalCost()).isEqualTo(UPDATED_TOTAL_COST);
    ...
    public void searchProductOrder() throws Exception {
        // Initialize the database
        productOrderService.save(productOrder);
        when(mockProductOrderSearchRepository.search(queryStringQuery("id:" + productOrder.getId())))
            .thenReturn(Collections.singletonList(productOrder));
