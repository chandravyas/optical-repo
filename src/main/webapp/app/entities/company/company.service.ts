...
export class CompanyService {
    ...
    private convertDateFromClient(company: ICompany): ICompany {
        const copy: ICompany = Object.assign({}, company, {
            createdOn: company.createdOn != null && company.createdOn.isValid() ? company.createdOn.toJSON() : null,
            updatedOn: company.updatedOn != null && company.updatedOn.isValid() ? company.updatedOn.toJSON() : null
        });
        return copy;
    }
    ...
    private convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
        res.body.forEach((company: ICompany) => {
            company.createdOn = company.createdOn != null ? moment(company.createdOn) : null;
            company.updatedOn = company.updatedOn != null ? moment(company.updatedOn) : null;
        });
        return res;
    }
}
